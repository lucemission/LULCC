...
harvestMinimumSoil = np.array([   76,   76,  67,  67,  175,  175,   45,  35,  95,   27,  173])  # Time of soil carbon to reach minimum (as found following harvest)
...
# BIOMASS
    [ # virgin
     ...
     # pasture
     [# clearing
      [0.534,0.534,0.534,0.534,0.534,0.534,0.534,0.534,0.534,0.534,0.534],
      # harvest
      [0.001,0.001,0.001,0.001,0.001,0.001,0.001,0.001,0.001,0.001,0.001],
      # abandonment
      [0.001,0.001,0.001,0.001,0.001,0.001,0.001,0.001,0.001,0.001,0.001],
...
# SS
    [# virgin
     ...
     [# clearing
      [0.001,0.001,0.001,0.001,0.001,0.001,0.001,0.001,0.001,0.001,0.001],
      # harvest
      [8.01,8.01,21.36,21.36,18.69,18.69,8.01,24.03,24.03,8.01,24.03],
      # abandonment
      [8.01,8.01,21.36,21.36,18.69,18.69,8.01,24.03,24.03,8.01,24.03],
      # others
      [0.001,0.001,0.001,0.001,0.001,0.001,0.001,0.001,0.001,0.001,0.001]],
     # pasture
     [# clearing
      [8.01,8.01,16.02,16.02,26.7,26.7,8.01,16.02,16.02,8.01,16.02],
      # harvest
      [0.001,0.001,0.001,0.001,0.001,0.001,0.001,0.001,0.001,0.001,0.001],
      # abandonment
      [0.001,0.001,0.001,0.001,0.001,0.001,0.001,0.001,0.001,0.001,0.001],
...
# SR
    [# virgin
     ...
     [# clearing
      [0.001,0.001,0.001,0.001,0.001,0.001,0.001,0.001,0.001,0.001,0.001],
      # harvest
      [2.67,2.67,5.34,5.34,8.01,8.01,2.67,5.34,5.34,2.67,8.01],
      # abandonment
      [0.001,0.001,0.001,0.001,0.001,0.001,0.001,0.001,0.001,0.001,0.001],
      # others
      [0.001,0.001,0.001,0.001,0.001,0.001,0.001,0.001,0.001,0.001,0.001]],
